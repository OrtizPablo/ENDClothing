...
enum ProductCellType {
    case imageCell(imagePath: String, titles: [[String]])
...
final class ProductViewModel: ProductViewModelProtocol {
    ...
    var navTitle: String { return product.name }
    lazy var cells: [ProductCellType] = {
        return [
            .imageCell(imagePath: product.imagePath, titles: [["UK 4", "UK 5", "UK 6"], ["UK 7", "UK 8", "UK 9"], ["UK 10", "UK 11", "UK 12"]]),
